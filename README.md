...
Based on the [socialize:commentable](https://atmospherejs.com/socialize/friendships) package but modified to use (validated) Meteor methods rather than client side operations and [coniel:can](https://atmospherejs.com/coniel/can) for authorization.
...
### Request (class) - Extends [BaseModel](https://github.com/coniel/meteor-base-model)  ###
...
### Friend (class) - Extends [BaseModel](https://github.com/coniel/meteor-base-model)  ###
